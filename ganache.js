...
var pkg = require('ganache-cli/package.json')
var {toChecksumAddress, BN} = require('ethereumjs-util')
var ganache = require('ganache-cli')
var to = ganache.to
var initArgs = require('ganache-cli/args')
...
function startGanache(err, result) {
  ...
  var [testAccountAddress, testAccountData] = Object.entries(accounts)[0]
...
var testAccountFile = (privateKey, account) => `
module.exports = {
